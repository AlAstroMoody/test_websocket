- Доделать оформление(вывод во первом окне в формате дата : успешно/нет)
- Данные по обработанным URL’ам сохранять в базу и при перезагрузке выводить их во
втором textarea. (Незамедлительно!)
- исправить выход за пределы списка
